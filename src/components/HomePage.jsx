          ...
          {games.map((game, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link
                  to="/1vs1"
                  className="inline-block bg-game-accent text-white px-4 py-2 rounded-md hover:bg-opacity-80 transition-colors duration-200"
                >
                  Play Now
                </Link>
              </div>
  ...
  return (
    <Link to={link} className="block">
      <div className="bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition duration-300">
        <div className="text-game-accent mb-4">{icon}</div>
